...
const HELP_TOPICS = [
    ...
    },
    {
        ...
        text: '当前消息、滑动分支、正文内容指纹和提交快照都对得上，才算最新正文已经推演。主状态条、此刻页与智能助手读取同一份结果。黄色点表示正文待推演、失败或需要处理；主题色小点只表示世界有新变化还没看。',
    },
    {
        id: 'injection',
        title: '正文注入',
    ...
    },
    {
        id: 'lingqi',
        title: '智能助手',
        keywords: ['智能助手', '助手', '剧情引导', '导演', '帮助'],
        text: '智能助手是插件内置的内置助手：可以聊天、解释插件、汇报世界总览，查询人物/暗流/记忆/设置，诊断推演与人物停滞，搜索或管理自己的聊天记录，也可以把“下一段想怎么玩”翻成导演剧情引导。真正发送、解除关系或删除聊天前都会先弹确认；删除智能助手聊天默认不删除长期记忆。智能助手聊天本身不是世界事实，用户的猜测不会自动写进人物或世界状态。',
    },
];
