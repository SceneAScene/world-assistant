...
const HELP_TOPICS = [
    {
        id: 'world-dynamic-concept',
        title: '世界动态是什么',
        keywords: ['世界动态', '后台', '正文', '镜头', '运行', '不注入', '不存在'],
        text: '世界动态就是这个故事世界本身的后台状态，正文只是当前镜头。某个模块不注入正文，不等于它不存在或停止运行；人物、事件、记忆、舆情仍会继续保存和发展。',
    },
    {
        id: 'simulation',
        title: '世界推演与停止',
    ...
    },
    {
        ...
        text: '当前消息、滑动分支、正文内容指纹和提交快照都对得上，才算最新正文已经推演。主状态条、此刻页与世界动态助手读取同一份结果。黄色点表示正文待推演、失败或需要处理；主题色小点只表示世界有新变化还没看。',
    },
    {
        id: 'injection',
        title: '正文注入',
    ...
    },
    {
        ...
        text: '“清理当前聊天缓存”只清可重建缓存和临时任务，不动人物、事件、记忆、世界钟和 API。“重置当前聊天数据”会把当前聊天的世界动态恢复为空白，同时清恢复点/分支快照避免旧分支数据再次恢复；聊天正文和 API 配置不会删除。',
    },
    {
        id: 'fact-correction',
        title: '事实纠错',
    ...
    },
    {
        id: 'lingqi',
        title: '世界动态助手',
        keywords: ['世界动态助手', '助手', '剧情引导', '导演', '帮助'],
        text: '世界动态助手是插件内置的内置助手：可以聊天、解释插件、汇报世界总览，查询人物/暗流/记忆/设置，诊断推演与人物停滞，搜索或管理自己的聊天记录，也可以把“下一段想怎么玩”翻成导演剧情引导。真正发送、解除关系或删除聊天前都会先弹确认；删除世界动态助手聊天默认不删除长期记忆。世界动态助手聊天本身不是世界事实，用户的猜测不会自动写进人物或世界状态。',
    },
];
