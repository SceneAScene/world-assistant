...
export async function writeSceneWorldSection(section, value) {
    const allowed = new Set(['world', 'people', 'publicOpinion', 'memory', 'chronicle', 'assistant', 'snapshots']);
...
export function sceneWorldUsage() {
    ...
    const sections = {};
    for (const key of ['sync', 'world', 'people', 'publicOpinion', 'memory', 'chronicle', 'assistant', 'snapshots']) {
